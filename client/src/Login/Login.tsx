...
export const Login: React.FC<{ userLogin: any }> = ({ userLogin }) => {
    ...
    const handleSignUpSubmit = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/user/${usernameSU}/${passwordSU}`, requestOptions);
            const msg = response.ok ? "You have successfully signed up. Proceed to login." : "User was not created successfully. Wrong format.";
        ...
        <div className="login">
            ...
            <div className="login__sign-in sign-in">
                ...
                <form className="sign-in__form sign-in-form">
                    ...
                    <div>
                        <button className="sign-in-form__submit-button" type="button" onClick={handleSignInSubmit}>Sign in</button>
                    </div>
                </form>
            ...
            <div className="login__sign-up sign-up">
                ...
                <form className="sign-up__form sign-up-form">
                    ...
                    <div>
                        <button className="sign-up-form__submit-button" type="button" onClick={handleSignUpSubmit}>Sign up</button>
                    </div>
                </form>
